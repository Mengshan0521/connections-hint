...
const siteMetadata = {
  ...
  siteUrl: 'https://www.connectionshint.online',
  ...
  analytics: {
    ...
    plausibleAnalytics: {
      plausibleDataDomain: 'connectionshint.online', // e.g. tailwind-nextjs-starter-blog.vercel.app
      src: 'https://app.pageview.app/js/script.js', // 添加这一行来自定义服务地址
    },
    // simpleAnalytics: {},
    // posthogAnalytics: {
    ...
    // },
    googleAnalytics: {
      googleAnalyticsId: 'G-BN4H8Q61TC', // e.g. G-XXXXXXX
    },
  },
  newsletter: {
